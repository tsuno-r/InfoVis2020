function Isosurfaces( volume, isovalue, camera, light )
{
    ...
    // Create color map
    var select_cmap = document.getElementById("color-map").value;
    var cmap = [];
    if (select_cmap == "Rainbow") {
        for ( var i = 0; i < 256; i++ )
        {
            var S = i / 255.0; // [0,1]
    ...
    }else if(select_cmap == "GreenWhite") {
    ...
    var reflection_model = document.getElementById("reflection-model").value;
    ...
    var material = new THREE.ShaderMaterial({
        ...
        uniforms: {
            ...
            ka: {type: 'float', value: document.getElementById("para_ka").value},
            kd: {type: 'float', value: document.getElementById("para_kd").value},
            ks: {type: 'float', value: document.getElementById("para_ks").value},
            n: {type: 'float', value: document.getElementById("para_n").value},
            m: {type: 'float', value: document.getElementById("para_m").value},
            f: {type: 'float', value: document.getElementById("para_f").value},
        }
    });
