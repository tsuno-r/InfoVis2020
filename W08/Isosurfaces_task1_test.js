function Isosurfaces( volume, isovalue )
{
        ...
        for ( var y = 0; y < volume.resolution.y - 1; y++ )
        {
            for ( var x = 0; x < volume.resolution.x - 1; x++ )
            {
                ...
                for ( var j = 0; lut.edgeID[index][j] != -1; j += 3 )
                {
                    ...
                    var v01 = interpolated_vertex( v0, v1, s0, s1, si);
                    var v23 = interpolated_vertex( v2, v3, s2, s3, si);
                    var v45 = interpolated_vertex( v4, v5, s4, s5, si);
    ...
    function calc_vertex_scalar(v, v0, v1, s0, s1)
    {  
        return (s0 + s1) / 2;
    }
